...
import { CalendarEvent, Mode } from '@/components/ui/full-calendar/calendar-types';
        ...
        <div>
            ...
            <div className='flex items-center justify-between'>
                <div className='flex items-center gap-2'>
                    <Button onClick={handleBackward} className='size-7' variant="outline"><ChevronLeftIcon /></Button>
                    <span>{dateDisplay}</span>
                    <Button onClick={handleForward} className='size-7' variant="outline"><ChevronRightIcon /></Button>
                </div>
                <div>
                    <Button onClick={toggleMode}>Change to: {mode === 'day' ? 'Week' : 'Day'}</Button>
